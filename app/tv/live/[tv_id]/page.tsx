    ...
    return (
        <div className="w-screen h-screen flex flex-col overflow-hidden selection:bg-rose-500/30 bg-slate-950 text-slate-200">
            ...
            {ocorrenciasHoje && ocorrenciasHoje.length > 0 && (
                <div className="w-full h-12 bg-red-950/90 border-b-2 border-red-600 flex items-center z-50 shrink-0 overflow-hidden relative shadow-[0_5px_20px_rgba(220,38,38,0.2)]">
