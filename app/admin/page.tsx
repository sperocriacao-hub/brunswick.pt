  ...
  return (
    <div className="max-w-7xl mx-auto">
      <header className="flex justify-between items-center mb-8 animate-fade-in">
        ...
        <Button variant="outline" disabled={isLoading} className="rounded-full shadow-sm" onClick={() => exportToExcel(financas, 'Relatorio_Financeiro_OEE.xlsx')}>
          {isLoading ? 'A calcular...' : 'Exportar OEE Financeiro (XLSX)'}
        </Button>
      </header>
