    ...
    <div className="dashboard-layout">
      ...
      <aside className="sidebar">
        ...
        <nav className="flex flex-col gap-4 mt-8">
          <a href="#" className="p-4 glass-panel flex items-center gap-4" style={{ borderLeft: "4px solid var(--primary)" }}>
          ...
          <a href="#" className="p-4" style={{ opacity: 0.7, transition: "opacity 0.2s" }}>
            <span style={{ fontWeight: 500 }}>Ordens de Produção</span>
          </a>
          <a href="#" className="p-4" style={{ opacity: 0.7, transition: "opacity 0.2s" }}>
            <span style={{ fontWeight: 500 }}>Configurações (Admin)</span>
          </a>
          <a href="#" className="p-4" style={{ opacity: 0.7, transition: "opacity 0.2s" }}>
